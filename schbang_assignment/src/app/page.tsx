...
export default function Home() {
  return (
    ...
    <div className=" ">
      <div className="circle Position tested-12 w-[500px] h-[500px] bg-[#FF5722] opacity-50 rounded-[100%] absolute z-n1 top-[50%] left-[50%] top-[0px] left-[-100px] translate-x-[-50%] translate-y-[-50%] blur-[150px] "></div>
