  ...
  return (
    <div className="flex flex-col sm:flex-row w-screen md:w-[1199px]  mt-12 mx-auto gap-5 overflow-hidden ">
      ...
      <div className="flex flex-col md:flex-row gap-4 m-4">
        <div className="flex flex-col text-center  p-10 md:p-16 w-[350px] h-[400px] m-auto  bg-white rounded-3xl hover:scale-105 hover:bg-red-100">
          <FramerMagnetic>
        ...
        <div className="flex flex-col text-center  p-10 md:p-16 w-[350px] h-[400px] m-auto md:h-full bg-white rounded-3xl hover:scale-105 hover:bg-red-100">
          <FramerMagnetic>
            <div className="w-full h-2/6">
